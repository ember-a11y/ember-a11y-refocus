...
export interface IndexRouteSignature {
  Args: {
    model: unknown;
    controller: unknown;
  };
...
<template>
  {{pageTitle "Ember A11y Refocus"}}

  <h1>
    Ember A11y ReFocus
  </h1>
  <p>
    Welcome to this demo app for ember-a11y-refocus! The GitHub repo is
    available here:
    <a
      href="https://github.com/ember-a11y/ember-a11y-refocus"
    >https://github.com/ember-a11y/ember-a11y-refocus</a>.
  </p>
  ...
  <p>Since
    ...
    new content is present, the screen-reader user has no way of knowing that
    new content exists, or that navigation to a new page was successful.
    Additionally, focus remains where it was, instead of getting reset in a
  ...
  <p>
    ...
    navigation purposes) have been treated a few ways in single-page
    applications:
    <ol>
      <li>
        completely ignored
  ...
  <p>
    The ember-a11y-refocus addon attempts to provide a sensible resolution for
    all involved:
    <ol>
      <li>
  ...
  <p>
    To try it out, use your keyboard to navigate through some of the items in
    the navbar while browsing with your screen reader of choice.
  </p>
